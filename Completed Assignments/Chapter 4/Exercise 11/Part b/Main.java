...
public class Main
{
  public static void main (String[]args)
  {
    ...
    System.out.println("Please enter amount of payment in dollars: ");
    float payment = input.nextFloat();
    String tendered = formatter.format(payment);
    System.out.println("The amount tendered is: " + tendered);
    float change = payment -afterTax;
    String change1 = formatter.format(change);
    System.out.println("Your chang due is: " + change1);
